        ...
        if request.method == 'POST':
            ...
            if form.is_valid():
                ...
                if tipo == "express":
                    ...
                    asunto = "Contacto"
                    td = "Asunto"
                mensaje = """<table width="100%" border="1" cellpadding="7" cellspacing="0" bordercolor="#CCCCCC"><tr><td>&nbsp;&nbsp;Nombre</td><td>"""+nombre+"""</td></tr><tr><td bgcolor="#f1f1f1">&nbsp;&nbsp;Mail</td><td bgcolor="#f1f1f1">"""+mail + \
                    """</td></tr><tr><td>&nbsp;&nbsp;Telefono</td><td>"""+telefono+"""</td></tr><tr><td bgcolor="#f1f1f1">"""+td + \
                    """</td><td bgcolor="#f1f1f1">"""+direccion + \
                    """</td></tr><tr><td>&nbsp;&nbsp;Detalle</td><td>""" + \
                    detalle+"""</td></tr></table>"""
